...
var teamsToRankOrig = ['319A', '319X', '319Z', '315A', '315T', '315R', '315V', '315W', '315Y', '315K', '5776E', '5776T', '5776X', '5776A', '5776P', '5327A', '5327B', '5327C', '5327E', '5327V', '5327Z', '1350X', '13931S', '8000A', '8000B', '8000C', '8000D'];
      ...
      if (teams.length != 3 && teams.length != 4) {
         ...
         for (i = 0; i < result.length; i++) {
            ...
            if (validComparison) {
               let curAdd = ""
               if (result[i].redscore == result[i].bluescore) {
                  curAdd += result[i].red1 + " " + result[i].red2 + " :red_circle: " + result[i].redscore + "-" + result[i].bluescore + " :blue_circle: " + result[i].blue1 + " " + result[i].blue2;
               }
               else if (result[i].redscore > result[i].bluescore) {
                  curAdd += "**" + result[i].red1 + " " + result[i].red2 + "** :red_circle: " + result[i].redscore + "-" + result[i].bluescore + " :blue_circle: " + result[i].blue1 + " " + result[i].blue2;
               }
